        ...
        <div className=" lg:flex md:grid justify-start items-center sm:grid">
          <div className=" lg:w-1/2 md:w1/2">
            ...
            <div className="flex items-center md:my-4">
              <span className=" font-bold md:text-7xl text-4xl ">Finance</span>
              <img
            ...
            <div>
              ...
              <div className="flex my-2 md:my-0">
                ...
                <div className=" w-9/12">
                  ...
                  <p>
                    Cebizpay has a team of well-trained customer support agents
                    available 24/7 to assist you with any issues you may have.
                    We offer multiple channels of communication to ensure that
                    you can easily reach us and receive prompt assistance.
                  </p>
                </div>
              </div>
              ...
              <div className="flex ">
                ...
                <div className=" w-9/12">
                  ...
                  <p>
                    Periodically, Cebizpay offers the best discounts and special
                    deals on all of our services, including data, airtime, and
                    cable subscriptions. Stay tuned for updates on our special
                    offers and take advantage of the opportunity to save on
                    these services.
                  </p>
                </div>
              </div>
      ...
      <div name="About Us" className=" md:px-28 px-7">
        <div className="flex gap-14 mt-7">
          <div className=" w-2/5">
            ...
            <p className="grid">
              Yes, we got you covered, With Cebizpay Enjoy a easy and fast data
          ...
          <div className="md:flex grid items-center justify-center">
            ...
            <div className="grid bg-TFramcol md:relative md:right-5 bottom-3 md:bottom-0  p-14 md:w-2/4 h-80 rounded-2xl  ">
              <p>
                ...
                smiles...they have the best customer service team ever...prompt
                and fast response to issues. Cebizpay thanks for always being
                true.
              </p>
              <div>
                <div className=" flex">
